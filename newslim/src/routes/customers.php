...
//Sign In
$app->get('/api/customer/log/{email}', function (Request $request, Response $response, array $args) {
...
$app->post('/api/customer/add', function (Request $request, Response $response, array $args) {
    ...
    $sql = "INSERT INTO customers (first_name,last_name,phone,email,address,city,state,password) VALUES 
    (:first_name,:last_name,:phone,:email,:address,:city,:state,:password)";
